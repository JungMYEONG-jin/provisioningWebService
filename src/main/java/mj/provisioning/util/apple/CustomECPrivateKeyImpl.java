 ...
 */
public final class CustomECPrivateKeyImpl extends PKCS8Key implements ECPrivateKey {
     ...
     */
    CustomECPrivateKeyImpl(byte[] encoded) throws InvalidKeyException {
        decode(encoded);
    }
     ...
     * KeyFactory.
     */
    CustomECPrivateKeyImpl(BigInteger s, ECParameterSpec params)
    ...
    CustomECPrivateKeyImpl(byte[] s, ECParameterSpec params)
            throws InvalidKeyException {
        this.arrayS = s.clone();
        this.params = params;
        makeEncoding(s);
